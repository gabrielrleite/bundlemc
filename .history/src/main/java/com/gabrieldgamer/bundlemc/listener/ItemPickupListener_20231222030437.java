...
import com.gabrieldgamer.bundlemc.StackDrops;
...
import com.gabrieldgamer.bundlemc.nms.NmsFacade;
...
public class ItemPickupListener implements Listener {
    ...
    private boolean performPickup(final Item item, final Inventory inventory, final Player player) {
        ...
        if (player != null) {
            val pickupEvent = new com.heroslender.herostackdrops.event.PlayerPickupItemEvent(player, item,
                    amount - leftOver);

...
public class ItemListener implements Listener {
    ...
    private StackResult spawnStack(ItemStack itemStack, int itemAmount, Entity source, @Nullable Item item) {
        if (configurationController.isItemDisabled(itemStack))
            return StackResult.DISABLED;
        ...
        if (configurationController.isStackOnSpawn()) {
            for (Entity entity : configurationController.getNearby(source)) {
                ...
                final Item targetItem = (Item) entity;
                if (configurationController.isSimilar(itemStack, targetItem.getItemStack())) {
                    ...
                    if (!metadata.isEmpty()) {
                        ...
                        Main.getInstance().updateItem(targetItem, amount);
        ...
        Main.getInstance().updateItem(item, itemAmount);
    ...
    private void onItemMerge(final ItemMergeEvent e) {
        ...
        Main.getInstance().updateItem(target, targetAmount + sourceAmount);

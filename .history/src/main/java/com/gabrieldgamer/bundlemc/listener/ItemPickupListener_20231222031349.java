...
import com.gabrieldgamer.bundlemc.controller.ConfigurationController;
import com.gabrieldgamer.bundlemc.event.PlayerPrePickupItemEvent;
...
import static com.gabrieldgamer.bundlemc.config.Constants.META_KEY;
...
public class ItemPickupListener implements Listener {
    ...
    public ItemPickupListener(Main plugin, ConfigurationController configurationController) {
        this.plugin = plugin;
    ...
    private boolean performPickup(final Item item, final Inventory inventory, final Player player) {
        ...
        if (player != null) {
            val pickupEvent = new com.gabrieldgamer.bundlemc.event.PlayerPickupItemEvent(player, item,
                    amount - leftOver);
        ...
        if (leftOver == 0) {
            ...
            Main.getInstance().updateItem(item, leftOver);
        }
